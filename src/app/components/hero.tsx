...
const Hero = () => {
  return (
    <section className="text-gray-600 body-font bg-gradient-to-br from-pink-100 via-gray-200 to-teal-100">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        >
          ...
          <motion.div
            className="w-[100px] h-[2px] bg-blue-900"
            initial={{ width: 0 }}
            animate={{ width: "100px" }}
            transition={{ duration: 1 }}
          />
          <motion.p
            className="mb-8 leading-relaxed text-gray-900"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
